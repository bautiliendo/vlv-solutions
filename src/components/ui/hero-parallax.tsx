...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-96 w-[30rem] relative shrink-0 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-lg"
    >
      <a
        href={product.link}
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6">
        <h2 className="text-white font-semibold text-lg group-hover/product:text-xl transition-all duration-300">
          {product.title}
        </h2>
      </div>
    </motion.div>
